namespace ACE.Entity.Enum.Properties
{
    public enum PropertyFloat : ushort
    {
        ...
        /// first player through is caught. Unset or &lt;= 0 falls back to the 2 s retail default, leaving every
        /// existing plate unchanged. Lower it on custom plates that need to catch a group.</summary>

...
namespace ACE.Server.WorldObjects
{
    public static class CharmAbilityRegistry
    {
        ...
        public const int ShadowCloneCharmAbilityId = 24;
        ...
        private static readonly Dictionary<int, AbilityEntry> Registry = new()
        {
            ...
            { ShadowCloneCharmAbilityId, new AbilityEntry(p => p.HasShadowCloneCharm, (p, v) => p.HasShadowCloneCharm = v, "Shadow Clone") },
        };
        ...
        private static readonly Dictionary<uint, int> WCIDToAbilityId = new()
        {
            ...
            // Shadow Clone Charm
            { 777700030, ShadowCloneCharmAbilityId },
        };

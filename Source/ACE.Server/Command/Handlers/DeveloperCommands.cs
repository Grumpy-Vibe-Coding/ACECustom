    ...
    public static class DeveloperCommands
    {
        ...
        */
        ...
        public static void HandleZcVitals(Session session, params string[] parameters)
        {
            ...
            var fortify = p.GetZoneCantripMax(ACE.Server.Managers.ZoneControl.ZoneCantrips.FortifyVitalsPct);
            var pctHp = p.GetZoneCantripBonus(ACE.Server.Managers.ZoneControl.ZoneCantrips.PctMaxHealthPct);
            ...
            foreach (var wo in p.EquippedObjects.Values)
            {
                ...
                rawFortifyMax = Math.Max(rawFortifyMax, wo.GetProperty((PropertyInt)ACE.Server.Managers.ZoneControl.ZoneCantrips.FortifyVitalsPct) ?? 0);
                rawPct += wo.GetProperty((PropertyInt)ACE.Server.Managers.ZoneControl.ZoneCantrips.PctMaxHealthPct) ?? 0;
            ...
            var regenSpecial = p.GetZoneCantripMax(ACE.Server.Managers.ZoneControl.ZoneCantrips.RegenSpecialMult);

...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        public static ConfigProperty<double> player_crit_damage_cap { get; private set; } = new(3.0, "Player physical crits are clamped to this multiple of a MAX normal hit (0 = uncapped). Default 3.0. /modifydouble player_crit_damage_cap.");

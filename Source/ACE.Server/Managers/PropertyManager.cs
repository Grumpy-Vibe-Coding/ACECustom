...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        public static ConfigProperty<long> invasion_treasure_id { get; private set; } = new(0, "TreasureDeath profile id rolled for invasion auto-loot rewards (set via /dev invasion treasure). 0 = no treasure roll.");
        ...
        public static ConfigProperty<long> invasion_boss_aug_item { get; private set; } = new(0, "Override the invasion boss Item Magic augmentation level. 0 = none.");
        public static ConfigProperty<long> invasion_boss_aug_life { get; private set; } = new(0, "Override the invasion boss Life Magic augmentation level. 0 = none.");
        public static ConfigProperty<long> invasion_boss_aug_war { get; private set; } = new(0, "Override the invasion boss War Magic augmentation level. 0 = none.");
        public static ConfigProperty<long> invasion_boss_aug_void { get; private set; } = new(0, "Override the invasion boss Void Magic augmentation level. 0 = none.");
        public static ConfigProperty<long> invasion_boss_aug_melee { get; private set; } = new(0, "Override the invasion boss Melee Defense augmentation level. 0 = none.");
        public static ConfigProperty<long> invasion_boss_aug_missile { get; private set; } = new(0, "Override the invasion boss Missile Defense augmentation level. 0 = none.");
        public static ConfigProperty<bool> invasion_boss_magic_only { get; private set; } = new(false, "Force the invasion boss to only cast spells.");
        public static ConfigProperty<bool> invasion_boss_infinite_mana { get; private set; } = new(true, "If TRUE, the invasion boss does not use mana when casting spells.");
        public static ConfigProperty<double> invasion_boss_magic_delay { get; private set; } = new(3.0, "The delay in seconds between magic attacks for the invasion boss.");
        public static ConfigProperty<long> invasion_boss_strength { get; private set; } = new(0, "Override strength for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_endurance { get; private set; } = new(0, "Override endurance for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_coordination { get; private set; } = new(0, "Override coordination for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_quickness { get; private set; } = new(0, "Override quickness for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_focus { get; private set; } = new(0, "Override focus for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_self { get; private set; } = new(0, "Override self for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_stamina { get; private set; } = new(0, "Override stamina for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_mana { get; private set; } = new(0, "Override mana for the invasion boss. 0 = default.");
        public static ConfigProperty<double> invasion_boss_crit_frequency { get; private set; } = new(0.0, "Override crit frequency for the invasion boss. 0.0 = default.");
        public static ConfigProperty<double> invasion_boss_crit_multiplier { get; private set; } = new(0.0, "Override crit multiplier for the invasion boss. 0.0 = default.");
        public static ConfigProperty<long> invasion_boss_damage_resist_rating { get; private set; } = new(0, "Override Damage Resist Rating for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_crit_rating { get; private set; } = new(0, "Override Crit Rating for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_crit_damage_rating { get; private set; } = new(0, "Override Crit Damage Rating for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_crit_resist_rating { get; private set; } = new(0, "Override Crit Resist Rating for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_crit_damage_resist_rating { get; private set; } = new(0, "Override Crit Damage Resist Rating for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_life_resist_rating { get; private set; } = new(0, "Override Life Resist Rating for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_dot_resist_rating { get; private set; } = new(0, "Override DoT Resist Rating for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_weakness_rating { get; private set; } = new(0, "Override Weakness Rating for the invasion boss. 0 = default.");
        public static ConfigProperty<double> invasion_boss_res_slash { get; private set; } = new(0.0, "Override slash resistance for the invasion boss. 0.0 = default.");
        public static ConfigProperty<double> invasion_boss_res_pierce { get; private set; } = new(0.0, "Override pierce resistance for the invasion boss. 0.0 = default.");
        public static ConfigProperty<double> invasion_boss_res_bludgeon { get; private set; } = new(0.0, "Override bludgeon resistance for the invasion boss. 0.0 = default.");
        public static ConfigProperty<double> invasion_boss_res_fire { get; private set; } = new(0.0, "Override fire resistance for the invasion boss. 0.0 = default.");
        public static ConfigProperty<double> invasion_boss_res_cold { get; private set; } = new(0.0, "Override cold resistance for the invasion boss. 0.0 = default.");
        public static ConfigProperty<double> invasion_boss_res_acid { get; private set; } = new(0.0, "Override acid resistance for the invasion boss. 0.0 = default.");
        public static ConfigProperty<double> invasion_boss_res_electric { get; private set; } = new(0.0, "Override electric resistance for the invasion boss. 0.0 = default.");
        public static ConfigProperty<double> invasion_boss_res_nether { get; private set; } = new(0.0, "Override nether resistance for the invasion boss. 0.0 = default.");
        public static ConfigProperty<double> invasion_boss_res_healthdrain { get; private set; } = new(0.0, "Override health drain resistance for the invasion boss. 0.0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_melee_def { get; private set; } = new(0, "Override Melee Defense skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_missile_def { get; private set; } = new(0, "Override Missile Defense skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_magic_def { get; private set; } = new(0, "Override Magic Defense skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_war { get; private set; } = new(0, "Override War Magic skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_void { get; private set; } = new(0, "Override Void Magic skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_life { get; private set; } = new(0, "Override Life Magic skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_creature { get; private set; } = new(0, "Override Creature Magic skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_item { get; private set; } = new(0, "Override Item Magic skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_heavy_weapons { get; private set; } = new(0, "Override Heavy Weapons skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_light_weapons { get; private set; } = new(0, "Override Light Weapons skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_finesse_weapons { get; private set; } = new(0, "Override Finesse Weapons skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_two_handed { get; private set; } = new(0, "Override Two Handed Combat skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_missile_weapons { get; private set; } = new(0, "Override Missile Weapons skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_dual_wield { get; private set; } = new(0, "Override Dual Wield skill for the invasion boss. 0 = default.");
        public static ConfigProperty<long> invasion_boss_skill_shield { get; private set; } = new(0, "Override Shield skill for the invasion boss. 0 = default.");

...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        public static ConfigProperty<bool> zc_killxp_diag { get; private set; } = new(true, "if TRUE, every governed (Zone Control) monster kill writes a [KILLXP] line per rewarded player to the server log - the launch-day XP/luminance readout, since the client filters that chat. ON by default while the shard is being tuned; switch off on a busy live shard. Use /modifybool zc_killxp_diag <true/false>.");

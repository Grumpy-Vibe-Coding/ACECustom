...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        public static ConfigProperty<bool> zc_tier_hit_gate_enabled { get; private set; } = new(false, "T11+ HIT GATE: when TRUE a player's melee, missile and spell attacks MISS OUTRIGHT against a monster at variation 11+ unless their augmentation counters meet that tier's requirement (WeaponScalingTier MinWieldCreature / MinWieldAugs / MinWieldTriune). All-or-nothing, no partial damage. Player -> monster only; monsters are never gated. Retail variations are never affected. Defaults FALSE - a mechanic that blocks hits should be switched on deliberately.");

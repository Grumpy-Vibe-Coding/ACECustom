...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        public static ConfigProperty<double> v11_pcthp_empower_mult { get; private set; } = new(1.5, "multiplier applied to the %HP floor when the attacking monster is currently Empowered (PropertyBool.IsEmpowered). Matches the normal empower melee bonus so empower stays meaningful when the floor dominates.");

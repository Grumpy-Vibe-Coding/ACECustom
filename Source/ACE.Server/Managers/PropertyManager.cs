...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        public static ConfigProperty<long> prestige_boundary_marker_weenie_class_id { get; private set; } = new(290, "Weenie Class ID used for spawning prestige boundary markers (default 290 = Sho Lantern)");
        public static ConfigProperty<long> prestige_boundary_marker_script_id { get; private set; } = new(0, "PlayScript ID used for prestige boundary markers (default 0 = None)");
        public static ConfigProperty<double> prestige_boundary_marker_scale { get; private set; } = new(2.5, "Scale of the prestige boundary markers (default 2.5)");
        ...
        public static ConfigProperty<double> life_prot_floor { get; private set; } = new(0.20, "protMod floor for all players — 0.20 = 80% max protection");
        public static ConfigProperty<bool> tier_mit_enabled { get; private set; } = new(true, "enables the tier mitigation multiplier system based on player aug sum");

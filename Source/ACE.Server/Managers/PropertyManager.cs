...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        public static ConfigProperty<long> room_assign_logout_hold_minutes { get; private set; } = new(15, "Room Assign: minutes a one-player room stays held for a character who logged out inside it (nobody else is sent there meanwhile). 0 = no hold. Change live: /modifylong room_assign_logout_hold_minutes <minutes>");

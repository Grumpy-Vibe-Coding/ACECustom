...
namespace ACE.Server.Network.Structure
{
    ...
    public partial class AppraiseInfo
    {
        ...
        private void BuildWeapon(WorldObject weapon, Player examiner)
        {
            ...
            var bypassPct = weapon.GetProperty(PropertyFloat.BypassPlayerProtectionsPercentage);
            if (bypassPct.HasValue && bypassPct.Value > 0.0)
            {
                effectDescriptions.Add($"- Protection Penetration: {bypassPct.Value:P0} Protection Ignored");
            }

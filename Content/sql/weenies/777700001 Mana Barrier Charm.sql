...
VALUES (777700001,    11, 1) /* IgnoreCollisions */
     ...
     , (777700001,  9040, 1) /* IsCharm — enables tier-aware appraise header */
...
VALUES (777700001,    1, 'Mana Barrier Charm')
     , (777700001,   14, '
Reduces damage taken by consuming mana. Ability deactivates if this charm leaves your inventory.
');
